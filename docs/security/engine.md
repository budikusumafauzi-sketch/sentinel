...
3. **Honest Coverage & Transparency:**  
   ...
   When no issues are found, client interfaces use honest terminology: *"Based on the checks available to Sentinel, no active security issues were detected across evaluated controls."* Absolute security is never claimed.
